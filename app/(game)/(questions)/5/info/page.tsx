        ...
        <Card className="bg-white/10 backdrop-blur-sm border-white/20 mb-8">
          <CardContent className="p-8">
            ...
            <div className="space-y-6 text-gray-200 font-light leading-relaxed">
              <p>
                Tebrikler! Üzerinde durduğunuz bu topraklar, Bizans'ın en büyük
                ayaklanmasına tanıklık etti. Hipodrom sadece bir yarış alanı
                değil, siyasetin de kalbiydi. "Maviler" asilleri, "Yeşiller" ise
                halkı temsil ediyordu. MS 532'de bu rakipler, "Nika!" (Zafer!)
                naralarıyla imparatora karşı birleşti. Çıkan kanlı Nika
                İsyanı'nda Ayasofya da dahil olmak üzere kentin büyük bölümü yok
                oldu.
              </p>
