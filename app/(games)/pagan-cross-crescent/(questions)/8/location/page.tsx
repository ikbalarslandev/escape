      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 max-w-4xl">
        ...
        <header className="text-center mb-8">
          ...
          <p className="text-lg md:text-xl text-primary-200 max-w-2xl mx-auto">
            Examine the magnificent entrance of the mosque
          </p>
        </header>
          ...
          <CardContent className="p-6 md:p-8">
            ...
            <div className="mb-6 md:mb-8">
              <div className="relative w-full h-48 md:h-64 rounded-xl overflow-hidden">
                <Image
                  src="/qs-imgs/pagan-cross-crescent/loc/8.JPG"
                  alt="Nuruosmaniye Mosque Main Entrance"
                  fill
            ...
            <div className="mb-6 md:mb-8">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-white flex items-center">
                  ...
                  MOSQUE OUT OF ENTRANCE
                </h2>
              </div>
              <p className="text-primary-200 leading-relaxed text-base md:text-lg">
                Stand before the entrance of Nuruosmaniye Mosque. Look closely
                at the details above the doorway to discover hidden symbols and
                meanings.
              </p>
            </div>
        ...
        {/* Next Button */}
        <div className="text-center">
          <Link href="/pagan-cross-crescent/8/qs">
        ...
        <footer className="text-center mt-8 md:mt-12">
          <p className="text-primary-300 font-light italic text-sm md:text-base">
            Where Baroque elegance meets Islamic tradition...
          </p>
        </footer>
      </div>
    </div>
