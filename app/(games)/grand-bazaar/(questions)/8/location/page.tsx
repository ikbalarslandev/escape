      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 max-w-4xl">
        ...
        <header className="text-center mb-8">
          ...
          <p className="text-lg md:text-xl text-primary-200 max-w-2xl mx-auto">
            Discover the historic han beyond the tower
          </p>
        </header>
          ...
          <CardContent className="p-6 md:p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <p className="text-primary-200 leading-relaxed text-base md:text-lg">
                    After the Çukur Kule, if you pass it and keep walking you
                    will see the Zincirli Han sign
                  </p>
                </div>

                <div className="flex items-start">
                  <FaArrowDown className="text-secondary-400 mr-3 mt-1 flex-shrink-0" />
                  <p className="text-primary-200 leading-relaxed text-base md:text-lg">
                    Go inside of it
                  </p>
                </div>
            ...
            <div className="mb-6 md:mb-8">
              ...
              <div className="relative w-full h-48 md:h-64 rounded-xl overflow-hidden">
                <Image
                  src="/qs-imgs/grand-bazaar/location/8/1.png"
                  alt="Zincirli Han sign"
                  fill
              ...
              <p className="text-primary-300 text-sm mt-2 text-center italic">
                Look for this sign as you continue past Çukur Kule
              </p>
            </div>
            ...
            <div className="mb-6 md:mb-8">
              <h3 className="text-lg font-semibold text-white mb-4 flex items-center">
                ...
                Zincirli Han Entrance
              </h3>
              <div className="relative w-full h-48 md:h-64 rounded-xl overflow-hidden">
                <Image
                  src="/qs-imgs/grand-bazaar/location/8/2.png"
                  alt="Zincirli Han entrance"
                  fill
                  className="object-cover z-10"
                  sizes="(max-width: 768px) 100vw, 768px"
                  priority
              ...
              <p className="text-primary-300 text-sm mt-2 text-center italic">
                This is what the entrance to Zincirli Han looks like
              </p>
            </div>
            ...
            <div className="text-center mb-6 md:mb-8">
              <Link
                href="https://maps.app.goo.gl/Ht1HGt5iQrfK853p6"
                target="_blank"
        ...
        <footer className="text-center mt-8 md:mt-12">
          <p className="text-primary-300 font-light italic text-sm md:text-base">
            Where merchants gathered and chains secured precious goods...
          </p>
        </footer>
      </div>
    </div>
