      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 max-w-4xl">
        ...
        <header className="text-center mb-8 md:mb-12">
          ...
          <p className="text-lg md:text-xl text-primary-200 font-light max-w-2xl mx-auto">
            Continue your journey to the next historical marvel
          </p>
        </header>
          ...
          <CardContent className="p-6 md:p-8">
            ...
            <div className="mb-6 md:mb-8">
              ...
              <p className="text-primary-200 leading-relaxed text-base md:text-lg">
                Now, we are going to Hagia Sophia. This amazing building was
                made by the Byzantine Empire. It was built after the old church
                was destroyed in the Nika Revolt. They finished it in only 5
                years, and it stayed the biggest church in the world for almost
                1000 years.
              </p>
            </div>
        ...
        {/* Next Button */}
        <div className="text-center">
          <Link href="/seventh-minaret/1/qs">
