      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 max-w-4xl">
        ...
        <header className="text-center mb-8 md:mb-12">
          ...
          <p className="text-lg md:text-xl text-primary-200 font-light max-w-2xl mx-auto">
            Complete your journey at the German Fountain
          </p>
        </header>
          ...
          <CardContent className="p-6 md:p-8">
            ...
            <div className="mb-6 md:mb-8">
              ...
              <p className="text-primary-200 leading-relaxed text-base md:text-lg">
                For the final question, we need to go to the German Fountain.
              </p>
            </div>
            ...
            <div className="text-center">
              <Link
                href="https://maps.app.goo.gl/7Aei3uL8B6UHakws5"
                target="_blank"
        ...
        {/* Next Button */}
        <div className="text-center">
          <Link href="/seventh-minaret/7/qs">
        ...
        <footer className="text-center mt-8 md:mt-12">
          <p className="text-primary-300 font-light italic text-sm md:text-base">
            May the power of the seals be with you. Get ready for the final
            step...
          </p>
        </footer>
      </div>
